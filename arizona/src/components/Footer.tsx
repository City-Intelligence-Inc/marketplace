...
export function Footer() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (mode === "subscribe") {
        apiUrl = `https://dhzmiptmem.us-east-1.awsapprunner.com/podcast/agents/b21ae987-5b7d-4b0a-844b-b3562358e3e8/subscribe-email?email=${encodeURIComponent(email)}`;
        successMessage = "Thanks for subscribing! Check your inbox.";
      } else {
        apiUrl = `https://dhzmiptmem.us-east-1.awsapprunner.com/podcast/agents/b21ae987-5b7d-4b0a-844b-b3562358e3e8/invite-email?email=${encodeURIComponent(email)}&inviter_name=${encodeURIComponent(inviterName)}`;
    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center space-y-6">
          {/* Brand */}
          <h3 className="text-2xl font-bold text-white">City Intelligence, Inc</h3>
